...
export default function Todofun() {
  ...
  return (
    ...
    >
      <TextField fullWidth label="TO-DO" id="fullWidth" placeholder='Enter your TO-DO' sx={{
    ...
    <Button  variant="contained" sx={{width:100, height:55, backgroundColor: '#7632cf',
        '&:hover': { backgroundColor: '#5a25a3' },}} >ADD</Button>
    </Stack>
    <Box sx={{display: 'flex', 
        justifyContent: 'left', 
        alignItems: 'left',
        ...
        <List>
           <ListItem>
            <ListItemText>helloo</ListItemText>
           </ListItem>
        </List>
    </Box>
      </Box>
